...
<style>/* ===== Тёмная тема для проекта ===== */
    ...
    /* Стили для отзывов (звёздный рейтинг) */
    .star-rating {
        display: flex;
        align-items: center;
        gap: 0.25rem;
    ...
    /* Специфичные классы для страницы статей (если нужны) */
    .articles-grid {
        display: grid;
