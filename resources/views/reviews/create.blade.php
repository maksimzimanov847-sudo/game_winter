        ...
        <form action="{{ route('reviews.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea name="comment" rows="4"
                          class="w-full px-3 py-2 border rounded-lg">{{ old('comment') }}</textarea>
            </div>
...
<style>
    ...
    /* Звездный рейтинг в опциях */
    option[value="1"]::before { content: "★"; margin-right: 0.5rem; }
    option[value="2"]::before { content: "★★"; margin-right: 0.5rem; }
    option[value="3"]::before { content: "★★★"; margin-right: 0.5rem; }
    option[value="4"]::before { content: "★★★★"; margin-right: 0.5rem; }
    option[value="5"]::before { content: "★★★★★"; margin-right: 0.5rem; }
